...
class DataPathProviderForTrain(DataPathProvider):
    ...
    def get_paths(self):
        ...
        print("test ids: " + ",".join([str(pid) for pid in self.test_pids]))
        print("validation ids: " + ",".join([str(pid) for pid in self.validation_pids]))
        print("train ids: " + ",".join([str(pid) for pid in self.pids if pid not in self.test_pids and pid not in self.validation_pids]))
